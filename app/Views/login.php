                        ...
                        <div class="flex flex-col w-full max-w-full px-3 mx-auto md:flex-0 shrink-0 md:w-6/12 lg:w-5/12 xl:w-4/12">
                            <div class="relative flex flex-col min-w-0 mt-32 break-words bg-transparent border-0 shadow-none rounded-2xl bg-clip-border">
                                <div class="p-6 pb-0 mb-0 bg-transparent border-b-0 rounded-t-2xl">
                                    <h3 class="relative z-10 text-2xl font-bold text-transparent bg-gradient-to-tl from-blue-600 to-cyan-400 bg-clip-text">Welcome back</h3>
                                ...
                                <div class="flex-auto p-6">
                                    <form role="form" method="POST" action="/login">
                                        ...
                                        <?php endif; ?>
                                        <label class="mb-2 ml-1 font-bold text-xs text-slate-700" for="email">Email</label>
                                        <div class="mb-4">
                                        ...
                                        <label class="mb-2 ml-1 font-bold text-xs text-slate-700" for="password">Password</label>
                                        <div class="mb-4">
                                ...
                                <div class="p-6 px-1 pt-0 text-center bg-transparent border-t-0 border-t-solid rounded-b-2xl lg:px-2">
                                    <p class="mx-auto mb-6 leading-normal text-sm">
                                        ...
                                        <a href="/inscription" class="relative z-10 font-semibold text-transparent bg-gradient-to-tl from-blue-600 to-cyan-400 bg-clip-text">Sign up</a>
                                    </p>
                                </div>
                            </div>
                        </div>
