<aside class=" z-0 max-w-62.5 ease-nav-brand z-990 fixed inset-y-0 my-4 ml-4 block w-full -translate-x-full flex-wrap items-center justify-between overflow-y-auto rounded-2xl border-0 bg-white p-0 antialiased shadow-none transition-transform duration-200 xl:left-0 xl:translate-x-0 xl:bg-transparent">
  <div class="h-19.5">
    <i class="absolute top-0 right-0 hidden p-4 opacity-50 cursor-pointer fas fa-times text-slate-400 xl:hidden" sidenav-close></i>
    <div class="block px-8 py-6 m-0 text-sm whitespace-nowrap text-slate-700" href="javascript:;">
      <img src="../public/img/logo-ct.png" class="inline h-full max-w-full transition-all duration-200 ease-nav-brand max-h-8" alt="main_logo" />
      <span class="ml-1 font-semibold transition-all duration-200 ease-nav-brand">Stocks</span>
    </div>
  </div>
    ...
    <ul class="flex flex-col pl-0 mb-0">
      <li class="mt-0.5 w-full">
        <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors" href="/">
          ...
          <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Acceuil</span>
        </a>
      </li>
      <?php if ($_SESSION['user']->getRole()->getName() == 'supplier') : ?>
        <li class="mt-0.5 w-full">
          <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors" href="/monstock">
            <div class="shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
              <symbol viewBox="0 0 48 48" id="arcticons-devcheck">
                <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M16.885 22.726c2.313-1.313 5.31-2.691 7-2.691c1.64 0-4.255 16.852-3.1 16.852a11.754 11.754 0 0 0 6.874-2.673"></path>
                <circle cx="24.799" cy="13.973" r="2.86" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></circle>
            ...
            <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Mon stock</span>
          </a>
        </li>
      <?php endif; ?>

      <li class="mt-0.5 w-full">
        <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors" href="/mescommandes">
          ...
          <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Mes commandes</span>
        </a>
      </li>

      <?php if ($_SESSION['user']->getRole()->getName() == 'supplier') : ?>
        <li class="mt-0.5 w-full">
          <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors" href="/commandes_recues">
            <div class="shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center fill-current stroke-0 text-center xl:p-2.5">
              <svg width="12px" height="12px" viewBox="0 0 43 36" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>credit-card</title>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Commandes reçus</span>
          </a>
        </li>
      <?php endif; ?>
